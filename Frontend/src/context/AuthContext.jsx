...
export const DEMO_USERS = {
  ...
  counsellor: {
    ...
    role: 'COUNSELLOR',
    roleTitle: 'Lead Clinical Psychologist',
    idBadge: 'AAROH-CNS-4402',
    district: 'South Delhi',
    state: 'Delhi NCT',
    avatar: 'RV',
    assignedCaseload: 18,
  ...
  district: {
    ...
    name: 'Ananya Sen',
    role: 'DISTRICT',
    roleTitle: 'Regional Triage Director',
    idBadge: 'AAROH-DST-1049',
    district: 'South Delhi',
    state: 'Delhi NCT',
    avatar: 'AS',
  ...
  state: {
    ...
    name: 'K. Ramanathan',
    role: 'STATE',
    roleTitle: 'State Oversight Director',
    idBadge: 'AAROH-STA-3320',
    state: 'Delhi NCT',
    avatar: 'KR',
    totalDistricts: 11,
  },
  national: {
    ...
    role: 'NATIONAL',
    roleTitle: 'Global Resilience Director',
    idBadge: 'AAROH-GLB-0081',
    ministry: 'Global Psychological Resilience & Human Care Directorate',
    avatar: 'PV',
    nationalCoverage: '28 Jurisdictions',
  },
  admin: {
    ...
    role: 'ADMIN',
    roleTitle: 'Platform & Cryptographic Auditor',
    idBadge: 'AAROH-SYS-0001',
    avatar: 'SA',
    systemStatus: 'Optimal (DPDP & ISO/IEC 27001 Verified)',
  },
};
