...
export const ProtectedRoute = ({ children, allowedRoles = [] }) => {
  ...
  // Exempt official roles from RBAC: Counsellor, District Official, State Official, National Director, System Authority
  // These roles have universal operational oversight across all portals
  const EXEMPT_ROLES = ['COUNSELLOR', 'DISTRICT', 'STATE', 'NATIONAL', 'ADMIN'];
  if (EXEMPT_ROLES.includes(currentUser?.role)) {
    return children;
  }

  // Check if current user's role is permitted (e.g. for VICTIM)
