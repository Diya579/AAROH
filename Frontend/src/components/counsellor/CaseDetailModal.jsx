...
import { InterventionRoutingModal } from './InterventionRoutingModal';
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <strong style={{ fontSize: '0.92rem', color: 'var(--ux4g-violet-950)' }}>
                    Active Statutory Intervention Strategy
                  </strong>
                </div>
                <span className="ux4g-badge ux4g-badge-primary">{caseData.stage}</span>
              </div>
              <p style={{ fontSize: '0.88rem', color: 'var(--ux4g-text-primary)', lineHeight: 1.5, marginBottom: '12px' }}>
                {caseData.recommendedIntervention}
              </p>
              
              {/* Assignment Team & Capacity Strip */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '10px', paddingTop: '10px', borderTop: '1px solid var(--ux4g-border)', fontSize: '0.8rem' }}>
                <div>
                  <span style={{ color: 'var(--ux4g-text-muted)' }}>Primary Assignee:</span>{' '}
                  <strong style={{ color: 'var(--ux4g-violet-950)' }}>{caseData.primaryAssignee || caseData.assignedOfficial}</strong>
                </div>
                <div>
                  <span style={{ color: 'var(--ux4g-text-muted)' }}>Backup Assignee:</span>{' '}
                  <strong style={{ color: 'var(--ux4g-violet-950)' }}>{caseData.backupAssignee || 'Dr. Sunita Rao'}</strong>
                </div>
                <div>
                  <span style={{ color: 'var(--ux4g-text-muted)' }}>Team Capacity:</span>{' '}
                  <span className="ux4g-badge ux4g-badge-low" style={{ fontSize: '0.72rem' }}>
                    {caseData.capacityIndicator || '85% Active'}
                  </span>
                </div>
              </div>
            </div>
